...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'ten-blog' ),
	'priority'   => 100,
...
$wp_customize->add_section('section_sidebar', array(    
	'title'       => __('Sidebar Options', 'ten-blog'),
...
$wp_customize->add_setting('blog_sidebar', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'ten_blog_sanitize_select',
	'transport'         => 'refresh',
	)
);
...
$wp_customize->add_control('blog_sidebar', 
	array(		
	'label' 	=> __('Blog Sidebar', 'ten-blog'),
	'section' 	=> 'section_sidebar',
	'settings'  => 'blog_sidebar',
	'type' 		=> 'radio',
	'choices' 	=> array(		
		'left-sidebar' 	=> __( 'Left Sidebar', 'ten-blog'),						
		'right-sidebar' => __( 'Right Sidebar', 'ten-blog'),	
		'no-sidebar' 	=> __( 'No Sidebar', 'ten-blog'),	
		),	
	)
);
...
$wp_customize->add_control('single_post_sidebar', 
	array(		
	'label' 	=> __('Single Post Sidebar', 'ten-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('archive_sidebar', 
	array(		
	'label' 	=> __('Archive Sidebar', 'ten-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('page_sidebar', 
	array(		
	'label' 	=> __('Page Sidebar', 'ten-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'ten-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'excerpt_length', array(
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'ten_blog_sanitize_number_range',
	'transport'         => 'refresh',
) );

$wp_customize->add_control( 'excerpt_length', array(
	'label'       => __( 'Excerpt Length', 'ten-blog' ),
	'description' => __( 'Note: Min 5 & Max 100.', 'ten-blog' ),
